...
*************************************************************/
%let path=/home/&sysuserid/EST241;
...
%macro unpack(unzip /* Full path pointing to where to create the EST241 data */
...
%let url=%str(http://dl.liveweb.sas.com/eldata/est241_oda.zip);
...
%unpack(%superq(path),est241.zip,est241)

/* added to set &path for elearning */
%let path=/home/&sysuserid/EST241/data;
